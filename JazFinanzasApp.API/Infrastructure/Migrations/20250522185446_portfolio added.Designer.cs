...
namespace JazFinanzasApp.API.Migrations
{
    ...
    [Migration("20250522185446_portfolio added")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JazFinanzasApp.API.Models.DTO.Report.CryptoStatsByDateCommerceDTO", b =>
                {
                    ...
                    b.ToTable("CryptoStatsByDateCommerceDTO");
                });

            modelBuilder.Entity("JazFinanzasApp.API.Models.DTO.Report.CryptoStatsByDateDTO", b =>
                {
                    b.Property<DateTime>("Date")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("CryptoStatsByDateDTO");
                });

            modelBuilder.Entity("JazFinanzasApp.API.Models.DTO.Report.StockStatsListDTO", b =>
                {
                    ...
                    b.ToTable("StockStatsListDTO");
                });

            modelBuilder.Entity("JazFinanzasApp.API.Models.DTO.Report.StocksGralStatsDTO", b =>
                {
                    b.Property<decimal>("ActualValue")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("StocksGralStatsDTO");
                });

            modelBuilder.Entity("JazFinanzasApp.API.Models.DTO.Report.TotalBalanceResult", b =>
                {
            ...
            modelBuilder.Entity("JazFinanzasApp.API.Models.Domain.AssetType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1071),
                            Environment = "FIAT",
                            Name = "Moneda",
                            UpdatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1074)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1077),
                            Environment = "CRYPTO",
                            Name = "Criptomoneda",
                            UpdatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1077)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1078),
                            Environment = "BOLSA",
                            Name = "Accion Argentina",
                            UpdatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1079)
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1079),
                            Environment = "BOLSA",
                            Name = "CEDEAR",
                            UpdatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1080)
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1081),
                            Environment = "BOLSA",
                            Name = "FCI",
                            UpdatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1081)
                        },
                        new
                        {
                            Id = 6,
                            CreatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1082),
                            Environment = "BOLSA",
                            Name = "Bono",
                            UpdatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1082)
                        },
                        new
                        {
                            Id = 7,
                            CreatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1083),
                            Environment = "BOLSA",
                            Name = "Accion USA",
                            UpdatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1083)
                        },
                        new
                        {
                            Id = 8,
                            CreatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1084),
                            Environment = "BOLSA",
                            Name = "Obligacion Negociable",
                            UpdatedAt = new DateTime(2025, 5, 22, 18, 54, 44, 299, DateTimeKind.Utc).AddTicks(1084)
                        });
                });
            ...
            modelBuilder.Entity("JazFinanzasApp.API.Models.Domain.BondPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JazFinanzasApp.API.Models.Domain.Portfolio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JazFinanzasApp.API.Models.Domain.Transaction", b =>
                {
                    ...
                    b.HasOne("JazFinanzasApp.API.Models.Domain.Portfolio", "Portfolio")
                        .WithMany()
